...
const MenFilter = () => {
  ...
  useEffect(() => {
    ...
    // Fetching the list of men's products from the backend API
    axios
      .get("https://mern-ecommerce-website-2tn3.onrender.com/api/men")
      .then((res) => {
  ...
  const handleRemoveProduct = async (id) => {
    try {
      await axios.delete(
        `https://mern-ecommerce-website-2tn3.onrender.com/api/men/${id}`
      );
