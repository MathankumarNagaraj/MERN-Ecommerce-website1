...
const FootwearFilter = () => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .get(
        "https://mern-ecommerce-website-2tn3.onrender.com/api/footwear"
      )
      .then((res) => {
  ...
  const handleRemoveProduct = async (id) => {
    try {
      await axios.delete(
        `https://mern-ecommerce-website-2tn3.onrender.com/api/footwear/${id}`
      );
  ...
  return (
    <>
      <Header />
      <main className="flex">
        <FilterTitles footwear={"font-bold"} />
